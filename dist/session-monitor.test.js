...
describe("SessionMonitor", () => {
    ...
    describe("startTurn", () => {
        it("spawns process with correct args", () => {
            ...
            expect(mockSpawn).toHaveBeenCalledWith(expect.any(String), expect.arrayContaining(["-p", "hello world", "--output-format", "stream-json"]), expect.objectContaining({ stdio: ["pipe", "pipe", "pipe"] }));
        });
        ...
        it("includes --resume when sessionId is set", () => {
            ...
            expect(mockSpawn).toHaveBeenLastCalledWith(expect.any(String), expect.arrayContaining(["--resume", "sess-abc"]), expect.any(Object));
        });
    });
