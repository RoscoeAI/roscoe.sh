...
describe("SessionList", () => {
    it("shows empty state when no sessions", () => {
        const { lastFrame } = render(_jsx(SessionList, { sessions: new Map(), activeSessionId: null }));
    ...
    it("renders session entries", () => {
        ...
        const { lastFrame } = render(_jsx(SessionList, { sessions: sessions, activeSessionId: "s1" }));
    ...
    it("wraps runtime metadata on narrower rails", () => {
        ...
        const { lastFrame } = render(_jsx(SessionList, { sessions: sessions, activeSessionId: "s1", width: 28 }));
        const frame = lastFrame();
