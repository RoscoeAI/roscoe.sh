...
export type TranscriptEntry = RemoteTurnEntry | LocalSuggestionEntry | LocalSentEntry | ToolActivityEntry | ErrorEntry;
...
export type AppAction = {
    ...
    id: string;
    text: string;
    delivery: Extract<LocalResponseDelivery, "edited" | "manual">;
} | {
    type: "SET_AUTO_MODE";
    enabled: boolean;
} | {
    ...
    id: string;
    state: LocalSuggestionEntry["state"];
} | {
